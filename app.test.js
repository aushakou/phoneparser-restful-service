...
describe('Testing POST requests:', () => {
  ...
  test('POST request with image 1 containing valid numbers', () => {
    // Asynchronous testing should be implemented
